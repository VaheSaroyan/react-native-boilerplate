...
function Home() {
  ...
  return (
    <Layout
      ...
      description="Get an architecture optimized for building your next solid cross-platform mobile application through separation of concerns between the UI and business logic."
    >
